...
import { addSessionForAthlete, fetchSessionsForAthlete, updateSession } from "@/services/sessionService";
...
export async function PUT(request: Request, { params }: { params: Promise<{ id: string }> }) {
    ...
    try {
        ...
        const session = await updateSession(body.documentId, payload);
